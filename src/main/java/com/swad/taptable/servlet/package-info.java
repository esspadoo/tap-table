 ...
 *
 * <p>This package contains a base servlet that manages access to the HikariCP connection pool, and
 * {@link com.swad.taptable.servlet.RestDispatcherServlet}, which routes incoming REST requests to
 * the appropriate RestResource handler based on the request URI and method.
 *
 * @author SWAD Team
 */
