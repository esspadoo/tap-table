...
public final class RestDispatcherServlet extends HttpServlet {
    ...
    private final Router router = new Router()
            ...
            .post("/rest/user/register", (req, res) -> new RegisterUserRR(req, res).serve(),
                    RouteAccess.PUBLIC)
            .get("/rest/user", (req, res) -> new GetUserRR(req, res).serve(),
                    RouteAccess.AUTHENTICATED)
            .put("/rest/user", (req, res) -> new EditUserRR(req, res).serve(),
                    RouteAccess.AUTHENTICATED)
            ...
            .get("/rest/ingredient", (req, res) -> new GetIngredientsRR(req, res).serve(),
                    RouteAccess.PUBLIC)
            .get("/rest/ingredient/{ingredient_id}",
                    (req, res) -> new GetIngredientRR(req, res).serve(), RouteAccess.PUBLIC)
            ...
            .get("/rest/promotion", (req, res) -> new GetPromotionsRR(req, res).serve(),
                    RouteAccess.STAFF_OR_ADMIN)
            .get("/rest/promotion/{promotion_code}",
                    (req, res) -> new CheckPromotionRR(req, res).serve(), RouteAccess.PUBLIC)
        ...
        try {
                    ...
                    if (JWTUtil.COOKIE_NAME.equals(cookie.getName())) {
                        try {
                            ...
                            req.setAttribute("user_id",
                                    String.valueOf(decoded.getClaim("user_id").asInt()));
            ...
            switch (result) {
                ...
                case NOT_FOUND: {
                    ...
                    Message m = new Message("Unknown resource requested.",
                ...
                case UNAUTHORIZED: {
                    ...
                    Message m = new Message("Authentication required.",
                            ErrorCodes.MISSING_AUTH_COOKIE, null);
                    m.toJSON(out);
                    break;
                }
                case FORBIDDEN: {
