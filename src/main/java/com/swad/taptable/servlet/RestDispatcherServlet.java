...
public final class RestDispatcherServlet extends HttpServlet {
  ...
  private final Router router = new Router()
      ...
      .post("/rest/user/login", (req, res) -> new AuthenticateUserRR(req, res).serve(),
          RouteAccess.PUBLIC)
      .post("/rest/user/logout", (req, res) -> new LogoutRR(req, res).serve(),
          RouteAccess.AUTHENTICATED)
      .post("/rest/user/register", (req, res) -> new RegisterUserRR(req, res).serve(),
          RouteAccess.PUBLIC)
      .get("/rest/user", (req, res) -> new GetUserRR(req, res).serve(), RouteAccess.AUTHENTICATED)
      .put("/rest/user", (req, res) -> new EditUserRR(req, res).serve(), RouteAccess.AUTHENTICATED)
      .delete("/rest/user", (req, res) -> new DeleteUserRR(req, res).serve(),
          RouteAccess.AUTHENTICATED)

      // category
      .post("/rest/category", (req, res) -> new CreateCategoryRR(req, res).serve(),
          RouteAccess.ADMIN_ONLY)
      .get("/rest/category", (req, res) -> new GetAllCategoriesRR(req, res).serve(),
          RouteAccess.PUBLIC)
      .delete("/rest/category/{category_name}",
          (req, res) -> new DeleteCategoryRR(req, res).serve(), RouteAccess.ADMIN_ONLY)
      ...
      .delete("/rest/ingredient/{ingredient_id}",
          (req, res) -> new DeleteIngredientRR(req, res).serve(), RouteAccess.STAFF_OR_ADMIN)
      ...
      .get("/rest/dish/{dish_id}", (req, res) -> new GetDishRR(req, res).serve(),
          RouteAccess.PUBLIC)
      .put("/rest/dish", (req, res) -> new EditDishRR(req, res).serve(), RouteAccess.STAFF_OR_ADMIN)
      ...
      .put("/rest/order/{order_id}/{order_status}",
          (req, res) -> new EditOrderStatusRR(req, res).serve(), RouteAccess.STAFF_OR_ADMIN)
      ...
      .get("/rest/promotion/{promotion_code}", (req, res) -> new CheckPromotionRR(req, res).serve(),
          RouteAccess.PUBLIC)
      .get("/rest/promotion/{promotion_code}/usage",
          (req, res) -> new CheckPromotionUsageRR(req, res).serve(), RouteAccess.AUTHENTICATED);
    ...
    try {
      ...
      switch (result) {
        ...
        case UNAUTHORIZED: {
          ...
          Message m = new Message("Authentication required.", ErrorCodes.MISSING_AUTH_COOKIE, null);
          m.toJSON(out);
          break;
        }
        case FORBIDDEN: {
