...
public final class ConnectionPoolSingleton {
    ...
    private static final Logger LOGGER = LogManager.getLogger(ConnectionPoolSingleton.class,
    ...
    /**
     * Private constructor to prevent instantiation of this utility class. This class is not meant
     * to be instantiated since it provides a static method for acquiring connections from the pool,
     * and all the state is managed by the container. If an attempt is made to instantiate this
     * class, an AssertionError is thrown to indicate that this is not allowed.
     */
    private ConnectionPoolSingleton() {
        new AssertionError(String.format("No instances of %s allowed.",
                ConnectionPoolSingleton.class.getName()));
    }
